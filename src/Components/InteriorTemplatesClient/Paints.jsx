    ...
    const paintTemplates = [
        {
            ...
            pricePerSqFt: 12,
            description: "Clean lines and subtle tones create a contemporary feel perfect for urban homes.",
        ...
        },
        {
            ...
            pricePerSqFt: 18,
            description: "Add glamour with our metallic finish that catches light beautifully.",
